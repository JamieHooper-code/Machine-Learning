...
# Print the first few rows of the master DataFrame for debugging
print("Master DataFrame before updates:")
...
for excel_file in excel_files:
    ...
    # Print a portion of the master DataFrame to check if the data has been updated correctly
    print(f"Master DataFrame after update with {month_year} data:")
    print(master_df.head())
